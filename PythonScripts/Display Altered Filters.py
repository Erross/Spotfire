#Script to display altered filters in the pages active filter scheme (insert the html into a text area at end of script) - Show_Filters is name of text area into which HTML is injected
...
for page in Application.Document.Pages:
	for vis in page.Visuals:
		if vis.Title == 'Show_Filters':
			ta=vis.As[VisualContent]()
